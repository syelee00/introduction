...
const groups: Group[] = [
  { title: "운동을 좋아합니다", subtitle: "MOVE WITH JOY", hint: "아래 카드를 하나씩 눌러보세요 :)", cards: [
    { label: "등산", icon: "⛰", description: "등린이지만, 열정은 뿜뿜! 100대 명산 챌린지에 도전하고 싶어요.", accent: "coral" },
    { label: "러닝", icon: "⌁", description: "10km 마라톤만 5번째. 10km 50분대 진입과 하프 마라톤에 도전하고 싶어요.", accent: "blue" },
  ...
  { title: "새롭게 만드는 걸\n좋아합니다", subtitle: "MAKE IT FROM ZERO", cards: [
    ...
    { label: "이모티콘", icon: "☺", description: "이런 걸 만들어 봤습니다. (쑥쓰)", accent: "yellow", gif: "/emoticon.gif" },
    { label: "집밥", icon: "♨", description: "이것저것 맛나게 해 먹는 걸 좋아해요.", accent: "coral" },
  ] },
